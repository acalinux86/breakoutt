...
{
    {
        ...
        TestMatrix4A = TestMatrix4A.identity().setElement(1, 0, 5.0f);
        TestMatrix4B = TestMatrix4B.identity().setElement(1, 0, 2.0f);

        Matrix4 TestMatrixC = TestMatrix4A * TestMatrix4B;
        float TestA = TestMatrixC.getElement(1, 0);
        float TestB = TestMatrixC.getElement(3, 3);
        assert(TestLast == 10.00f);
        assert(TestFirst == 1.00f);
    }
}
